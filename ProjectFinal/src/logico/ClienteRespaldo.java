...
public class ClienteRespaldo {
    ...
    /*
    Función: enviarRespaldo
    Argumentos: 
        (File) ficheroBinario: El archivo local clinica.dat a enviar.
        (String) reporteTexto: El resumen estadístico generado.
    Objetivo: Conectar al socket del servidor y transmitir los datos.
    Retorno: (boolean): true si el envío fue exitoso, false si falló.
    */
