...
public class ListarAdministradores extends JDialog {
	...
	private void modificarAdmin() {
		...
		JOptionPane.showMessageDialog(this, "Administrador modificado correctamente.", "Éxito",
	...
	private void cambiarEstadoAdmin() {
		...
		if (usuarioActual != null && usuarioActual instanceof Administrativo
				&& usuarioActual.getId() == selectedAdmin.getId()) {
			JOptionPane.showMessageDialog(this, "No puedes inhabilitarte a ti mismo.", "Acción Bloqueada",
					JOptionPane.ERROR_MESSAGE);
			return;
		}

		if (selectedAdmin.isActivo()) {
			String razon = JOptionPane.showInputDialog(this, "Razón de inhabilitación:", "Confirmar",
					JOptionPane.WARNING_MESSAGE);
