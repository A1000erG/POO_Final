...
public class ListarPacientes extends JDialog {
	...
	private void modificarPaciente() {
		...
		if (txtNombre.getText().isEmpty() || txtTelefono.getText().trim().length() < 10) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Paciente modificado correctamente.", "Éxito",
					JOptionPane.INFORMATION_MESSAGE);
			loadPacientes(txtBuscador.getText());

		} catch (Exception e) {
			JOptionPane.showMessageDialog(this, "Error en formato de fecha (AAAA-MM-DD).", "Error",
