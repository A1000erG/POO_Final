...
public class ListarEnfermedades extends JDialog {
	...
	public ListarEnfermedades() {
		...
		ImageIcon iconGen = new ImageIcon(getClass().getResource("/Imagenes/thermometer.png"));
	...
	private void modificarEnfermedad() {
		...
		JOptionPane.showMessageDialog(this, "Enfermedad modificada correctamente.", "Éxito",
	...
	private void eliminarEnfermedad() {
		...
		if (confirm == JOptionPane.YES_OPTION) {
			...
			limpiarFormulario();
			loadEnfermedades(txtBuscador.getText());
			JOptionPane.showMessageDialog(this, "Enfermedad eliminada correctamente.", "Éxito",
					JOptionPane.INFORMATION_MESSAGE);
		}
	}
}